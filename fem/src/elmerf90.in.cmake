...
if test "$ELMERSOLVER_LINK_LIBRARY" = ""; then
  ELMERLIBRARY=@ELMERLIBRARY_DEFAULT_LINKING@
else
  ELMERLIBRARY=$ELMERSOLVER_LINK_LIBRARY
fi


if test @HAVE_ELMERICE@ = "TRUE"; then
    ELMERICE_LIB=$LIBDIR/../../share/elmersolver/lib
    LIBELMERICE="-Wl,-rpath,$ELMERICE_LIB $ELMERICE_LIB/ElmerIceSolvers.so $ELMERICE_LIB/ElmerIceUSF.so"
...
cmd="$FC $ELMERLIBRARY $* @CMAKE_Fortran_FLAGS@ @ELMER_F90FLAGS@ @CMAKE_SHARED_LIBRARY_Fortran_FLAGS@ @CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS@ -I$INCLUDE -L$LIBDIR $LIBELMERICE $MMGINCLUDE $MMGLIBDIR $PARMMGINCLUDE $PARMMGLIBDIR -shared"
printf "%s " $cmd
printf "\n"
$FC $ELMERLIBRARY $* @CMAKE_Fortran_FLAGS@ @ELMER_F90FLAGS@ @CMAKE_SHARED_LIBRARY_Fortran_FLAGS@ @CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS@ -I$INCLUDE -L$LIBDIR $LIBELMERICE $MMGINCLUDE $MMGLIBDIR $PARMMGINCLUDE $PARMMGLIBDIR -shared 
